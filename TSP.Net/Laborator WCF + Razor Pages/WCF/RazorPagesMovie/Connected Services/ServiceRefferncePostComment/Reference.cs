...
namespace ServiceRefferncePostComment
{
    ...
    public partial class Post : object
    {
        ...
        private ServiceRefferncePostComment.Comment[] CommentsField;
        ...
        public ServiceRefferncePostComment.Comment[] Comments
        {
            get
            {
    ...
    public partial class Comment : object
    {
        ...
        private ServiceRefferncePostComment.Post PostField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public ServiceRefferncePostComment.Post Post
        {
            get
            {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceRefferncePostComment.IPostComment")]
    public interface IPostComment
    {
        ...
        System.Threading.Tasks.Task<bool> AddPostAsync(ServiceRefferncePostComment.Post post);
        ...
        System.Threading.Tasks.Task<ServiceRefferncePostComment.Post> UpdatePostAsync(ServiceRefferncePostComment.Post post);
        ...
        System.Threading.Tasks.Task<ServiceRefferncePostComment.Post> GetPostByIdAsync(int id);
        ...
        System.Threading.Tasks.Task<ServiceRefferncePostComment.Post[]> GetPostsAsync();
        ...
        System.Threading.Tasks.Task<bool> AddCommentAsync(ServiceRefferncePostComment.Comment comment);
        ...
        System.Threading.Tasks.Task<ServiceRefferncePostComment.Comment> UpdateCommentAsync(ServiceRefferncePostComment.Comment newComment);
        ...
        System.Threading.Tasks.Task<ServiceRefferncePostComment.Comment> GetCommentByIdAsync(int id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    public interface IPostCommentChannel : ServiceRefferncePostComment.IPostComment, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    public partial class PostCommentClient : System.ServiceModel.ClientBase<ServiceRefferncePostComment.IPostComment>, ServiceRefferncePostComment.IPostComment
    {
        ...
        public System.Threading.Tasks.Task<bool> AddPostAsync(ServiceRefferncePostComment.Post post)
        {
            return base.Channel.AddPostAsync(post);
        }
        
        public System.Threading.Tasks.Task<ServiceRefferncePostComment.Post> UpdatePostAsync(ServiceRefferncePostComment.Post post)
        {
        ...
        public System.Threading.Tasks.Task<ServiceRefferncePostComment.Post> GetPostByIdAsync(int id)
        {
            return base.Channel.GetPostByIdAsync(id);
        }
        
        public System.Threading.Tasks.Task<ServiceRefferncePostComment.Post[]> GetPostsAsync()
        {
            return base.Channel.GetPostsAsync();
        }
        
        public System.Threading.Tasks.Task<bool> AddCommentAsync(ServiceRefferncePostComment.Comment comment)
        {
            return base.Channel.AddCommentAsync(comment);
        }
        
        public System.Threading.Tasks.Task<ServiceRefferncePostComment.Comment> UpdateCommentAsync(ServiceRefferncePostComment.Comment newComment)
        {
            return base.Channel.UpdateCommentAsync(newComment);
        }
        
        public System.Threading.Tasks.Task<ServiceRefferncePostComment.Comment> GetCommentByIdAsync(int id)
        {
